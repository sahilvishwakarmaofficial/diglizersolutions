...
export interface ClientEntry {
  ...
  logo?: string;
  logoAlt?: string;
  /** Verified origin of the stored logo file. Empty when no logo is published. */
  logoSource?: string;
...
export const clients: ClientEntry[] = [
  {
    ...
    logo: "/media/logos/genetics-cryobank.webp",
    logoAlt: "Genetics Cryobank official logo",
    logoSource: "https://geneticscryobank.com/wp-content/uploads/2025/02/final-logo.png",
    logoVerified: true,
  ...
  },
  {
    ...
    slug: "yashoda-ivf",
    logo: "/media/logos/yashoda-ivf.webp",
    logoAlt: "Yashoda IVF & Fertility Centre official logo",
    logoSource: "https://yashodaivf.com/assets/images/logos/yashoda_ivf_logo_v3.png",
    logoVerified: true,
    industry: "Healthcare and Fertility",
    category: ["Healthcare", "Fertility"],
    industrySlug: "healthcare-fertility-hospitals",
  ...
  },
  {
    ...
    displayName: "Grace26",
    slug: "grace26",
    logo: "/media/logos/grace26.webp",
    logoAlt: "Grace26 official logo",
    logoSource: "https://grace26.in/images/brand/grace26-logo.png",
    logoVerified: true,
  ...
  },
  {
    ...
    slug: "tripwithowners",
    logo: "/media/logos/tripwithowners.webp",
    logoAlt: "TripWithOwners official logo",
    logoSource: "https://tripwithowners.com/logo-white.png",
    logoVerified: true,
  ...
  },
  {
    ...
    displayName: "Prober",
    slug: "prober",
    logo: "/media/logos/prober.webp",
    logoAlt: "Prober logo",
    logoSource: "Official logo file supplied by the client for this engagement.",
    logoVerified: true,
  ...
  },
  {
    ...
    slug: "aikaa-fashion",
    logo: "/media/logos/aikaa-fashion.webp",
    logoAlt: "Aikaa Fashion official logo",
    logoSource: "https://aikaafashion.com/cdn/shop/files/Aikaa-Logo.png",
    logoVerified: true,
  ...
  },
  {
    ...
    logo: "/media/logos/dnyanasadhana-college.webp",
    logoAlt: "Satish Pradhan Dnyanasadhana College, Thane official logo",
    logoSource: "https://www.dnyanasadhanacollege.org/images/logo/logo-final.png",
    logoVerified: true,
  ...
  },
  {
    ...
    logo: "/media/logos/maharashtra-police.webp",
    logoAlt: "Maharashtra Police official emblem",
    logoSource: "Official logo file supplied by the client for this engagement.",
    logoVerified: true,
  ...
  },
  {
    ...
    logo: "/media/logos/suviksha-hospital.webp",
    logoAlt: "Suviksha Hospital logo",
    logoSource: "Official logo file supplied by the client for this engagement.",
    logoVerified: true,
  ...
  },
  {
    ...
    logo: "/media/logos/mimas-world-hospitals.webp",
    logoAlt: "MIMAS World Hospitals official logo",
    logoSource: "https://mimasworldhospitals.com/wp-content/uploads/sites/7/2025/05/Logo_11zon-1-scaled-e1747200656871.jpg",
    logoVerified: true,
    industry: "Healthcare & Hospitals",
    category: ["Healthcare"],
    industrySlug: "healthcare-fertility-hospitals",
  ...
  },
  {
    ...
    slug: "mark-jewells",
    logo: "/media/logos/mark-jewells.webp",
    logoAlt: "Mark Jewells logo",
    logoSource: "Official logo file supplied by the client for this engagement.",
    logoVerified: true,
  ...
  },
  {
    ...
    slug: "ather-energy",
    logo: "/media/logos/ather-energy.webp",
    logoAlt: "Ather Energy logo",
    logoSource: "Official logo file supplied by the client for this engagement.",
    logoVerified: true,
  ...
  },
  {
    ...
    slug: "trusterra",
    logo: "/media/logos/trusterra.webp",
    logoAlt: "TrusTerra official logo",
    logoSource: "https://www.trusterra.in/assets/logo.png",
    logoVerified: true,
    industry: "Mobility, Automotive & EV Technology",
    category: ["Mobility", "Technology"],
    industrySlug: "mobility-automotive-ev-technology",
