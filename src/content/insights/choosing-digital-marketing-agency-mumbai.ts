...
export const choosingDigitalMarketingAgencyMumbai: InsightArticle = {
  slug: "how-to-choose-a-digital-marketing-agency-in-mumbai",
  title: "How to Choose a Digital Marketing Agency in Mumbai",
  excerpt:
  ...
  tags: ["choosing a marketing agency", "Mumbai marketing agency", "agency evaluation"],
  primaryKeyword: "how to choose a digital marketing agency in Mumbai",
  secondaryKeywords: [
  ...
  clusterSlug: "choosing-agency-mumbai",
  ...
  heroImageDirection:
    "Flat illustration of a magnifying glass over a stylised city skyline silhouette, aubergine/violet palette, no real building photography.",
  intro: [
  ...
  sections: [
    {
      heading: "Define your goal before you start looking at agencies",
      paragraphs: [
    ...
    {
      heading: "Start from your need, not the agency's specialities list",
      paragraphs: [
    ...
    {
      heading: "Check for relevant experience, not just years in business",
      paragraphs: [
    ...
    {
      heading: "Match the service on offer to what you actually need",
      paragraphs: [
    ...
    {
      heading: "Look at their process, not just their portfolio",
      paragraphs: [
    ...
    {
      heading: "Evaluate the portfolio for relevance, not just polish",
      paragraphs: [
    ...
    {
      heading: "Understand where strategy ends and execution begins",
      paragraphs: [
    ...
    {
      heading: "Ask about reporting and ownership of your accounts",
      steps: [
        "Confirm that ad accounts, analytics and website access remain in your business's own accounts, not the agency's personal logins.",
        "Ask what a monthly report actually contains — request a sample.",
        "Ask who on the team will work on your account day to day, not just who presents the pitch.",
        "Ask what happens to your creative files, content calendar and account access if you end the engagement.",
      ],
    },
    {
      heading: "Evaluate category experience carefully",
      paragraphs: [
    ...
    {
      heading: "Judge communication style before you sign anything",
      paragraphs: [
    ...
    {
      heading: "Clarify ownership of accounts and assets in writing",
      paragraphs: [
    ...
    {
      heading: "Ask these questions during the pitch or discovery call",
      bullets: [
    ...
    {
      heading: "Watch for these red flags",
      bullets: [
  ...
  checklist: {
    title: "Agency shortlist checklist",
    items: [
  ...
  faqs: [
    {
      question: "Should I choose a large agency or a smaller specialist studio?",
      answer:
    ...
    {
      question: "How long should I trial an agency before committing to a long contract?",
      answer:
    ...
    {
      question: "What should I ask to see before hiring?",
      answer:
    ...
    {
      question: "How important is it that an agency has worked in my exact industry before?",
      answer:
    ...
    {
      question: "What is a reasonable way to compare two agency proposals?",
      answer:
    ...
    {
      question: "Is it normal for an agency to ask for account access before a contract is signed?",
      answer:
    ...
    {
      question: "What should happen if I want to end an agency engagement?",
      answer:
  ...
  relatedServices: ["strategy-consulting", "brand-creative"],
  relatedIndustries: [],
  relatedCaseStudies: [],
  relatedArticles: [
  ...
  ctaType: "contact",
  sources: [
    { label: "Google Partners Directory", url: "https://www.google.com/partners/" },
    { label: "Meta Business Partner Directory", url: "https://www.facebook.com/business/partner-directory" },
  ],
  status: "Published",
};
